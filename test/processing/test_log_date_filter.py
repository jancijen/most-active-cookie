...
class TestLogDateFilter(object):
    ...
    def test_different_data_lengths(self, cookies, timestamps, desired_date):
        cropped_cookies = cookies[1:]
        LogDateFilter.filter_cookies(cropped_cookies, timestamps, desired_date)

    def test_filter_ok(self, cookies, timestamps, desired_date, expected_filtered_cookies):
        assert LogDateFilter.filter_cookies(cookies, timestamps, desired_date) == expected_filtered_cookies, \
